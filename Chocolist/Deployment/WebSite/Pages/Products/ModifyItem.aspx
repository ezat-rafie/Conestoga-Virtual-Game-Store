<%@ Page Title="Modify Item" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ModifyItem.aspx.cs" Inherits="Chocolist.Pages.Products.ModifyItem" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form class="container p-2" id="frmCreateItem" style="background-color: #282B2E; border-radius: 5px; box-shadow: rgb(0 0 0 / 0.40) 5px 5px 10px;">
        <div class="row m-1">
            <div class="mb-4">
                <h3 class="mx-auto" style="width: fit-content; float: left; color:darkgrey; padding-left: 20px;">Edit Item</h3>
            </div>
        </div>
        <div class="row m-1">
            <div class="col-4">
                <div id="divItemInput" runat="server">
                    ...
                    <div class="row m-1 mb-3">
                        ...
                        <asp:TextBox Rows="4" class="w-100 text-input" ID="txtDescription" placeholder="Item Description" runat="server"></asp:TextBox>
                ...
                <div class="row m-1 mb-4 itemttype">
                    <div class="col">
                        <div class="form-check mb-1 row">
                            <asp:RadioButton class="form-check-label" ID="radTypeGame" Text="Game" Checked="True" GroupName="ItemTypeRadio" runat="server" oncheckedchanged="GameType_Changed" AutoPostBack="true" Enabled="false"/><br />
                        </div>
                        <div class="form-check row mb-1">
                            <asp:RadioButton class="form-check-label" ID="radTypeMerch" Text="Merchandise" GroupName="ItemTypeRadio" runat="server" oncheckedchanged="GameType_Changed" AutoPostBack="true" Enabled="false"/><br />
                        </div>
                    </div>
                </div>  
                <div id="divGame" runat="server">
                    ...
                    <div class="row m-1 mb-4 platforms">
                        <div class="col">
                            ...
                            <div class="form-check row mb-1">
                                <asp:RadioButton class="form-check-label" ID="radPlayStation" Text="Play Station" GroupName="PlatformRadio" runat="server" /><br />
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-8">
                <div class="row m-1 mb-2 cover-card">
                    ...
                    <img src="/images/placeholder.jpg" class="game-images" id="coverImage" runat="server"/>
                </div>
                <div class="row m-1 mb-4 cover-card">
                    <a href="#" class="btn btn-secondary mx-auto mb-2 buttons">Add Screenshot</a>
                    <div class="row m-1">
                        <div class="col-4">
                            <img src="/images/placeholder.jpg" class="game-images" id="itemImage1" runat="server"/>
                        </div>
                        <div class="col-4">
                            <img src="/images/placeholder.jpg" class="game-images" id="itemImage2" runat="server"/>
                        </div>
                        <div class="col-4">
                            <img src="/images/placeholder.jpg" class="game-images" id="itemImage3" runat="server"/>
                        </div>
                    </div>
                </div>
            </div>
