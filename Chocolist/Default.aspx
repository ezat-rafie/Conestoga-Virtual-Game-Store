        ...
        <div class="tabContents">
            <asp:MultiView ID="MultiView1" ActiveViewIndex="0" runat="server">
                ...
                <asp:View ID="tabEvent" runat="server">
                    <div class="row">
                        <div class="mb-4">
                            <asp:Label ID="EventSearchResult" runat="server" class="mx-auto" Style="width: fit-content; float: left; color: darkgray; font-size: large; padding-left: 20px; font-weight: bold;"></asp:Label>
                        </div>
